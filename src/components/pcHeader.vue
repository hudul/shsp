<template>
  <header class="header-pc view-width">
    ...
    <ul class="menu">
      ...
      <li @mouseenter="handelSolutionMenuShow" @mouseleave="handelSolutionMenuHidden">
        <span>解决方案</span>
    ...
    <div class="right"><button class="btnSize1 button btnStyle3">免费试用</button></div>
  </header>
</template>
...
export default defineComponent({
  ...
  methods: {
    handelSolutionMenuShow () {
      console.log(1)
      this.solutionMenuShow = true
    },
    handelSolutionMenuHidden () {
      console.log(0)
      this.solutionMenuShow = false
    }
  }
})
</script>
